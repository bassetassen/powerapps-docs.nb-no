...
Følgende datatyper kan ikke redigeres i redigerbare rutenett: Kunde- og Partylist-oppslagsfelt, sammensatte (adresse)felt, tilstands-/statusfelt, felt knyttet til oppslagsenheter (for eksempel forretningsforbindelsesenheten inkluderer et kontaktoppslag, der Kontakt-feltet kan redigeres, men EmailAddress(Contact)-feltet kan ikke redigeres).  
