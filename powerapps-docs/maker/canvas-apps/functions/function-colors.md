...
**ColorValue**-funksjonen returnerer en farge basert på en CSS-fargestreng.  Både navn på CSS-farger, for eksempel RosyBrown og hex-verdiene, for eksempel «#bc8f8f», kan brukes.

**RGBA**-funksjonen returnerer en farge basert på røde, grønne og blå fargekomponenter. Den inneholder også en Alfa-komponent som brukes til å blande fargene på objekter som er lagdelt oppå hverandre.  Alfa varierer fra 0 eller 0 %, som er fullstendig gjennomsiktig og usynlig, til 1 eller 100 %, som er helt ugjennomsiktig og blokkerer lagene fullstendig.

**ColorFade**-funksjonen returnerer en lysere eller mørkere versjon av en farge. Mengden toning varierer fra 1 eller -100% (som gjør fullstendig mørk og en farge til svart) til 0 (som har ingen innvirkning på fargen) til 1 eller 100% (som gjør fargen til hvit fullstendig).

## <a name="syntax"></a>Syntaks

**Color**.*ColorName*

* *ColorName* – obligatorisk.  Et fargenavn for gjennomgripende stilark (CSS).  Se listen nedenfor for mulige opplistingsverdier.

**ColorValue**( *CSSColor* )

* *CSSColor* – obligatorisk.  En fargedefinisjon for gjennomgripende stilark (CSS).  Både navn på farger, for eksempel OliveDrab og hex-verdiene, for eksempel «#6b8e23», kan brukes.  

**RGBA**( *Red*; *Green*; *Blue*; *Alpha* )

* *Red*, *Green*, *Blue* – obligatorisk.  Fargekomponentverdier fra 0 (ingen fargemetning) til 255 (full fargemetning).
...
* *FadeAmount* – obligatorisk.  Et tall mellom -1 og 1.  -1 gjør en farge fullstendig svart, 0 har ingen innvirkning på fargen og 1 gjør en farge fullstendig hvit. Du kan også bruke en prosent fra -100% til 100%
