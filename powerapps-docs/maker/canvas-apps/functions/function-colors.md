...
Bruke innebygde fargeverdier, definere egendefinerte farger og bruke alfa kanal.

## <a name="description"></a>Beskrivelse

Ved hjelp av den **farge** opplisting, du får enkelt tilgang til fargene som er definert av HTML gjennomgripende stilark (CSS). For eksempel **Color.Red** returnerer rent rødt. Du finner en liste over disse fargene på slutten av dette emnet.

Den **ColorValue** -funksjonen returnerer en farge basert på en fargestreng i en CSS. Strengen kan ha ett av disse skjemaene:

- **CSS-fargenavn:** **«RoxyBrown»** og **"OliveDrab"** er eksempler. Disse navnene ikke ta med mellomrom. Listen over støttede fargene vises senere i dette emnet.
- **6-sifrede heksadesimal verdi:** Som et eksempel **"#ffd700"** er den samme som **"Gull"** . Strengen er i formatet "#*rrggbb*» der *rr* er den røde delen i to heksadesimale sifre, *gg* er grønne og *bb* er blå.
- **8-sifret heksadesimal verdi:** For eksempel **"#ff7f5080"** er den samme som **"Korallrød"** med en 50% alpha-kanal. Strengen er i formatet "#*rrggbbaa*» der *rr*, *gg*, og *bb* er identisk med 6-sifrede skjemaet. Alpha kanalen er representert av *aa*: **00** representerer helt gjennomsiktig, og **ff** representerer helt ugjennomsiktig.

Den **RGBA** -funksjonen returnerer en farge basert på røde, grønne og blå komponenter. Funksjonen inkluderer også en alfa kanal for å blande fargene på kontrollene som er lagdelt foran hverandre. En alfa kanal varierer fra 0 eller 0% (som er fullstendig gjennomsiktig og usynlig) til 1 eller 100% (som er helt ugjennomsiktig og blokkerer fullstendig ut alle lag bak en kontroll).

**ColorFade**-funksjonen returnerer en lysere eller mørkere versjon av en farge. Mengden toning varierer fra -1 (som gjør fullstendig mørk og en farge til svart) til 0 (som ikke påvirker fargen) til 1 (som gjør fargen til hvit fullstendig).

## <a name="alpha-channel"></a>Alpha-kanal

I en lerretsapp, kan du laget Kontroller foran hverandre og angir gjennomsiktigheten til en kontroll for alle kontroller som står bak den. Derfor skal farger blandes gjennom lagene. Dette diagrammet viser for eksempel hvordan tre primære fargene blande med en alfa innstillingen på 50%:

> [!div class="mx-imgBorder"]
> ![Tre primære farger med en alfa innstillingen på 50%](media/function-colors/alpha-primary.png)

Du kan også blande bilder i filformater som støtter alfa kanaler. For eksempel du kan ikke blande JPEG-filer, men du kan blande PNG-filer. Neste grafikken viser den samme røde, grønne og blå fargene fra det forrige eksemplet, men fargen rød vises som en krusedull (i stedet for en sirkel) i PNG-filer med en 50% alpha-kanal:

> [!div class="mx-imgBorder"]
> ![Rød, bølgete med en alfa innstillingen på 50% foran blå og grønn sirkler](media/function-colors/alpha-image.png)

Hvis du angir en **farge** -opplistingsverdi eller du bygge en **ColorValue** formelen med et fargenavn eller en 6-sifrede heksadesimal verdi, alfa innstillingen er 100%, som er helt ugjennomsiktig.
...
- *CSSColor* – obligatorisk.  En fargedefinisjon for gjennomgripende stilark (CSS). Du kan angi enten et navn, for eksempel **OliveDrab**, eller en heksadesimal verdi, som **#6b8e23** eller **#7fffd420**. Hex-verdiene kan ta form av enten #*rrggbb* eller #*rrggbbaa*.

**RGBA**( *Red*, *Green*, *Blue*, *Alpha* )

- *Red*, *Green*, *Blue* – obligatorisk.  Fargekomponent verdier, som i området 0 (ingen fargemetning) til 255 (full fargemetning).
- *Alpha* – obligatorisk.  Alpha-komponent som strekker seg fra 0 (helt gjennomsiktig) til 1 (helt ugjennomsiktig). Du kan også bruke en prosentandel, fra 0 til 100 %.

**ColorFade**( *Color*, *FadeAmount* )

- *Color* – obligatorisk.  En fargeverdi, for eksempel **Color.Red**, eller utdataene fra **ColorValue** eller **RGBA**.
- *FadeAmount* – obligatorisk.  Et tall mellom -1 og 1. -1 gjør fullstendig mørk og en farge til svart, 0, påvirker ikke fargen og 1 gjør fargen til hvit fullstendig. Du kan også bruke en prosent fra -100% til 100%.

## <a name="built-in-colors"></a>Innebygde farger

| Color-opplisting | ColorValue | RGBA | Fargekart |
| --- | --- | --- | --- |
| **Color.AliceBlue** |**ColorValue( "#f0f8ff"&nbsp;)**<br>**ColorValue («skifergrå»&nbsp;)** |**RGBA(&nbsp;240,&nbsp;248,&nbsp;255,&nbsp;1&nbsp;)** |![aliceblue](./media/function-colors/color-aliceblue.png) |
...
| **Color.Aqua** |**ColorValue ("#00ffff"&nbsp;)**<br>**ColorValue («AKVAMARIN»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![aqua](./media/function-colors/color-aqua.png) |
...
| **Color.Bisque** |**ColorValue ("#ffe4c4"&nbsp;)**<br>**ColorValue («GULGRØNN»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;228,&nbsp;196,&nbsp;1&nbsp;)** |![bisque](./media/function-colors/color-bisque.png) |
...
| **Color.CadetBlue** |**ColorValue ("#5f9ea0"&nbsp;)**<br>**ColorValue («Pudderblå»&nbsp;)** |**RGBA(&nbsp;95,&nbsp;158,&nbsp;160,&nbsp;1&nbsp;)** |![cadetblue](./media/function-colors/color-cadetblue.png) |
| **Color.Chartreuse** |**ColorValue ("#7fff00"&nbsp;)**<br>**ColorValue («IRRGRØNN»&nbsp;)** |**RGBA (&nbsp;127,&nbsp;255,&nbsp;0,&nbsp;1&nbsp;)** |![chartreuse](./media/function-colors/color-chartreuse.png) |
...
| **Color.Coral** |**ColorValue ("#ff7f50"&nbsp;)**<br>**ColorValue («korallrød»&nbsp;)** |**RGBA (&nbsp;255,&nbsp;127,&nbsp;80,&nbsp;1&nbsp;)** |![coral](./media/function-colors/color-coral.png) |
...
| **Color.Cornsilk** |**ColorValue ("#fff8dc"&nbsp;)**<br>**ColorValue («Lys gul»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;248,&nbsp;220,&nbsp;1&nbsp;)** |![cornsilk](./media/function-colors/color-cornsilk.png) |
...
| **Color.DarkGreen** |**ColorValue ("#006400"&nbsp;)**<br>**ColorValue («Lime»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;100,&nbsp;0,&nbsp;1&nbsp;)** |![darkgreen](./media/function-colors/color-darkgreen.png) |
...
| **Color.DarkMagenta** |**ColorValue ("#8b008b"&nbsp;)**<br>**ColorValue («fiolett»&nbsp;)** |**RGBA (&nbsp;139,&nbsp;0,&nbsp;139,&nbsp;1&nbsp;)** |![darkmagenta](./media/function-colors/color-darkmagenta.png) |
...
| **Color.DarkSalmon** |**ColorValue ("#e9967a"&nbsp;)**<br>**ColorValue («Olivengrønn»&nbsp;)** |**RGBA (&nbsp;233,&nbsp;150,&nbsp;122,&nbsp;1&nbsp;)** |![darksalmon](./media/function-colors/color-darksalmon.png) |
| **Color.DarkSeaGreen** |**ColorValue ("#8fbc8f"&nbsp;)**<br>**ColorValue («SKIFERGRÅ»&nbsp;)** |**RGBA (&nbsp;143,&nbsp;188,&nbsp;143,&nbsp;1&nbsp;)** |![darkseagreen](./media/function-colors/color-darkseagreen.png) |
...
| **Color.DarkSlateGray** |**ColorValue ("#2f4f4f"&nbsp;)**<br>**ColorValue («turkis»&nbsp;)** |**RGBA(&nbsp;47,&nbsp;79,&nbsp;79,&nbsp;1&nbsp;)** |![darkslategray](./media/function-colors/color-darkslategray.png) |
...
| **Color.DarkTurquoise** |**ColorValue ("#00ced1"&nbsp;)**<br>**ColorValue («HIMMELBLÅ»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;206,&nbsp;209,&nbsp;1&nbsp;)** |![darkturquoise](./media/function-colors/color-darkturquoise.png) |
| **Color.DarkViolet** |**ColorValue ("#9400 d 3"&nbsp;)**<br>**ColorValue («DarkViolet»&nbsp;)** |**RGBA(&nbsp;148,&nbsp;0,&nbsp;211,&nbsp;1&nbsp;)** |![darkviolet](./media/function-colors/color-darkviolet.png) |
| **Color.DeepPink** |**ColorValue ("#ff1493"&nbsp;)**<br>**ColorValue («dyp rosa»&nbsp;)** |**RGBA (&nbsp;255,&nbsp;20,&nbsp;147,&nbsp;1&nbsp;)** |![deeppink](./media/function-colors/color-deeppink.png) |
...
| **Color.DodgerBlue** |**ColorValue ("#1e90ff"&nbsp;)**<br>**ColorValue («skifergrå»&nbsp;)** |**RGBA (&nbsp;30,&nbsp;144,&nbsp;255,&nbsp;1&nbsp;)** |![dodgerblue](./media/function-colors/color-dodgerblue.png) |
...
| **Color.Fuchsia** |**ColorValue ("#ff00ff"&nbsp;)**<br>**ColorValue («fuksia»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;0,&nbsp;255,&nbsp;1&nbsp;)** |![fuchsia](./media/function-colors/color-fuchsia.png) |
...
| **Color.GoldenRod** |**ColorValue ("#daa520"&nbsp;)**<br>**ColorValue («gyldenris»&nbsp;)** |**RGBA(&nbsp;218,&nbsp;165,&nbsp;32,&nbsp;1&nbsp;)** |![goldenrod](./media/function-colors/color-goldenrod.png) |
| **Color.Gray** |**ColorValue ("#808080"&nbsp;)**<br>**ColorValue («Grå»&nbsp;)** |**RGBA (&nbsp;128,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![gray](./media/function-colors/color-gray.png) |
| **Color.Green** |**ColorValue ("#008000"&nbsp;)**<br>**ColorValue («Grønn»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;128,&nbsp;0,&nbsp;1&nbsp;)** |![green](./media/function-colors/color-green.png) |
| **Color.GreenYellow** |**ColorValue ("#adff2f"&nbsp;)**<br>**ColorValue («Chartreuse»&nbsp;)** |**RGBA(&nbsp;173,&nbsp;255,&nbsp;47,&nbsp;1&nbsp;)** |![greenyellow](./media/function-colors/color-greenyellow.png) |
| **Color.Grey** |**ColorValue ("#808080"&nbsp;)**<br>**ColorValue («grått»&nbsp;)** |**RGBA (&nbsp;128,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![grey](./media/function-colors/color-grey.png) |
...
| **Color.HotPink** |**ColorValue ("#ff69b4"&nbsp;)**<br>**ColorValue («Lys GULLRISGUL»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;105,&nbsp;180,&nbsp;1&nbsp;)** |![hotpink](./media/function-colors/color-hotpink.png) |
| **Color.IndianRed** |**ColorValue ("#cd5c5c"&nbsp;)**<br>**ColorValue («Sterk rosa»&nbsp;)** |**RGBA(&nbsp;205,&nbsp;92,&nbsp;92,&nbsp;1&nbsp;)** |![indianred](./media/function-colors/color-indianred.png) |
...
| **Color.Khaki** |**ColorValue ("#f0e68c"&nbsp;)**<br>**ColorValue («KAKI»&nbsp;)** |**RGBA(&nbsp;240,&nbsp;230,&nbsp;140,&nbsp;1&nbsp;)** |![khaki](./media/function-colors/color-khaki.png) |
...
| **Color.LavenderBlush** |**ColorValue ("#fff0f5"&nbsp;)**<br>**ColorValue («gamle kniplinger»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;240,&nbsp;245,&nbsp;1&nbsp;)** |![lavenderblush](./media/function-colors/color-lavenderblush.png) |
...
| **Color.LightCoral** |**ColorValue ("#f08080"&nbsp;)**<br>**ColorValue («Mørk»&nbsp;)** |**RGBA(&nbsp;240,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![lightcoral](./media/function-colors/color-lightcoral.png) |
| **Color.LightCyan** |**ColorValue( "#e0ffff"&nbsp;)**<br>**ColorValue («Mørk blå»&nbsp;)** |**RGBA(&nbsp;224,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![lightcyan](./media/function-colors/color-lightcyan.png) |
| **Color.LightGoldenRodYellow** |**ColorValue ("#fafad2"&nbsp;)**<br>**ColorValue («Lys gul»&nbsp;)** |**RGBA(&nbsp;250,&nbsp;250,&nbsp;210,&nbsp;1&nbsp;)** |![lightgoldenrodyellow](./media/function-colors/color-lightgoldenrodyellow.png) |
...
| **Color.LightPink** |**ColorValue ("#ffb6c1"&nbsp;)**<br>**ColorValue («Lys GULGRÅ»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;182,&nbsp;193,&nbsp;1&nbsp;)** |![lightpink](./media/function-colors/color-lightpink.png) |
...
| **Color.LightSeaGreen** |**ColorValue( "#20b2aa"&nbsp;)**<br>**ColorValue («lys blå»&nbsp;)** |**RGBA(&nbsp;32,&nbsp;178,&nbsp;170,&nbsp;1&nbsp;)** |![lightseagreen](./media/function-colors/color-lightseagreen.png) |
| **Color.LightSkyBlue** |**ColorValue ("#87cefa"&nbsp;)**<br>**ColorValue («Mørk himmelblå»&nbsp;)** |**RGBA(&nbsp;135,&nbsp;206,&nbsp;250,&nbsp;1&nbsp;)** |![lightskyblue](./media/function-colors/color-lightskyblue.png) |
...
| **Color.Lime** |**ColorValue ("#00ff00"&nbsp;)**<br>**ColorValue («SITRUSGRØNN»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;255,&nbsp;0,&nbsp;1&nbsp;)** |![lime](./media/function-colors/color-lime.png) |
| **Color.LimeGreen** |**ColorValue ("#32 cd 32"&nbsp;)**<br>**ColorValue («Mørk»&nbsp;)** |**RGBA(&nbsp;50,&nbsp;205,&nbsp;50,&nbsp;1&nbsp;)** |![limegreen](./media/function-colors/color-limegreen.png) |
...
| **Color.Maroon** |**ColorValue ("#800000"&nbsp;)**<br>**ColorValue («RØDBRUN»&nbsp;)** |**RGBA(&nbsp;128,&nbsp;0,&nbsp;0,&nbsp;1&nbsp;)** |![maroon](./media/function-colors/color-maroon.png) |
...
| **Color.MediumBlue** |**ColorValue ("#0000 cd"&nbsp;)**<br>**ColorValue («lys stålblå»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;0,&nbsp;205,&nbsp;1&nbsp;)** |![mediumblue](./media/function-colors/color-mediumblue.png) |
| **Color.MediumOrchid** |**ColorValue ("#ba55d3"&nbsp;)**<br>**ColorValue («Mellomorkide»&nbsp;)** |**RGBA(&nbsp;186,&nbsp;85,&nbsp;211,&nbsp;1&nbsp;)** |![mediumorchid](./media/function-colors/color-mediumorchid.png) |
...
| **Color.MediumVioletRed** |**ColorValue ("#c71585"&nbsp;)**<br>**ColorValue («Mørk»&nbsp;)** |**RGBA (&nbsp;199,&nbsp;21,&nbsp;133,&nbsp;1&nbsp;)** |![mediumvioletred](./media/function-colors/color-mediumvioletred.png) |
| **Color.MidnightBlue** |**ColorValue ("#191970"&nbsp;)**<br>**ColorValue («lys»&nbsp;)** |**RGBA (&nbsp;25,&nbsp;25,&nbsp;112,&nbsp;1&nbsp;)** |![midnightblue](./media/function-colors/color-midnightblue.png) |
| **Color.MintCream** |**ColorValue ("#f5fffa"&nbsp;)**<br>**ColorValue («Mørk turkis»&nbsp;)** |**RGBA(&nbsp;245,&nbsp;255,&nbsp;250,&nbsp;1&nbsp;)** |![mintcream](./media/function-colors/color-mintcream.png) |
| **Color.MistyRose** |**ColorValue ("#ffe4e1"&nbsp;)**<br>**ColorValue («Kraftig TREFARGET»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;228,&nbsp;225,&nbsp;1&nbsp;)** |![mistyrose](./media/function-colors/color-mistyrose.png) |
| **Color.Moccasin** |**ColorValue ("#ffe4b5"&nbsp;)**<br>**ColorValue («Sjøgrønn»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;228,&nbsp;181,&nbsp;1&nbsp;)** |![moccasin](./media/function-colors/color-moccasin.png) |
| **Color.NavajoWhite** |**ColorValue («#ffdead»&nbsp;)**<br>**ColorValue («Mørk grønn»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;222,&nbsp;173,&nbsp;1&nbsp;)** |![navajowhite](./media/function-colors/color-navajowhite.png) |
| **Color.Navy** |**ColorValue ("#000080"&nbsp;)**<br>**ColorValue («Marineblå»&nbsp;)** |**RGBA (&nbsp;0,&nbsp;0,&nbsp;128,&nbsp;1&nbsp;)** |![navy](./media/function-colors/color-navy.png) |
| **Color.OldLace** |**ColorValue ("#fdf5e6"&nbsp;)**<br>**ColorValue («IBENHOLT»&nbsp;)** |**RGBA(&nbsp;253,&nbsp;245,&nbsp;230,&nbsp;1&nbsp;)** |![oldlace](./media/function-colors/color-oldlace.png) |
| **Color.Olive** |**ColorValue ("#808000"&nbsp;)**<br>**ColorValue («Mosegrønn»&nbsp;)** |**RGBA(&nbsp;128,&nbsp;128,&nbsp;0,&nbsp;1&nbsp;)** |![olive](./media/function-colors/color-olive.png) |
...
| **Color.OrangeRed** |**ColorValue ("#ff4500"&nbsp;)**<br>**ColorValue («KHAKI»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;69,&nbsp;0,&nbsp;1&nbsp;)** |![orangered](./media/function-colors/color-orangered.png) |
| **Color.Orchid** |**ColorValue ("#da70d6"&nbsp;)**<br>**ColorValue («Orkide»&nbsp;)** |**RGBA(&nbsp;218,&nbsp;112,&nbsp;214,&nbsp;1&nbsp;)** |![orchid](./media/function-colors/color-orchid.png) |
...
| **Color.PaleGreen** |**ColorValue ("#98fb98"&nbsp;)**<br>**ColorValue («Mørk cyan»&nbsp;)** |**RGBA(&nbsp;152,&nbsp;251,&nbsp;152,&nbsp;1&nbsp;)** |![palegreen](./media/function-colors/color-palegreen.png) |
| **Color.PaleTurquoise** |**ColorValue («#afeeee»&nbsp;)**<br>**ColorValue («Lys cyan»&nbsp;)** |**RGBA (&nbsp;175,&nbsp;238,&nbsp;238,&nbsp;1&nbsp;)** |![paleturquoise](./media/function-colors/color-paleturquoise.png) |
...
| **Color.Plum** |**ColorValue ("#dda0dd"&nbsp;)**<br>**ColorValue («Plomme»&nbsp;)** |**RGBA(&nbsp;221,&nbsp;160,&nbsp;221,&nbsp;1&nbsp;)** |![plum](./media/function-colors/color-plum.png) |
...
| **Color.Purple** |**ColorValue ("#800080"&nbsp;)**<br>**ColorValue («LILLA»&nbsp;)** |**RGBA (&nbsp;128,&nbsp;0,&nbsp;128,&nbsp;1&nbsp;)** |![purple](./media/function-colors/color-purple.png) |
| **Color.Red** |**ColorValue («#ff0000»&nbsp;)**<br>**ColorValue («Rød»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;0,&nbsp;0,&nbsp;1&nbsp;)** |![red](./media/function-colors/color-red.png) |
...
| **Color.Salmon** |**ColorValue ("#fa8072"&nbsp;)**<br>**ColorValue («Lakserød»&nbsp;)** |**RGBA(&nbsp;250,&nbsp;128,&nbsp;114,&nbsp;1&nbsp;)** |![salmon](./media/function-colors/color-salmon.png) |
...
| **Color.Silver** |**ColorValue ("#c0c0c0"&nbsp;)**<br>**ColorValue («Sølv»&nbsp;)** |**RGBA(&nbsp;192,&nbsp;192,&nbsp;192,&nbsp;1&nbsp;)** |![silver](./media/function-colors/color-silver.png) |
...
| **Color.SlateGray** |**ColorValue ("#708090"&nbsp;)**<br>**ColorValue («Skiferblå»&nbsp;)** |**RGBA(&nbsp;112,&nbsp;128,&nbsp;144,&nbsp;1&nbsp;)** |![slategray](./media/function-colors/color-slategray.png) |
...
| **Color.Snow** |**ColorValue («#fffafa»&nbsp;)**<br>**ColorValue («Snø»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;250,&nbsp;250,&nbsp;1&nbsp;)** |![snow](./media/function-colors/color-snow.png) |
...
| **Color.Teal** |**ColorValue ("#008080"&nbsp;)**<br>**ColorValue («Blågrønn»&nbsp;)** |**RGBA (&nbsp;0,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![teal](./media/function-colors/color-teal.png) |
...
| **Color.Transparent** |**ColorValue ("#00000000"&nbsp;)**<br>**ColorValue («Gjennomsiktig»&nbsp;)** |**RGBA(&nbsp;0,&nbsp;0,&nbsp;0,&nbsp;0&nbsp;)** |![gjennomsiktig](./media/function-colors/color-transparent.png) |
| **Color.Turquoise** |**ColorValue ("#40e0d0"&nbsp;)**<br>**ColorValue («turkis»&nbsp;)** |**RGBA(&nbsp;64,&nbsp;224,&nbsp;208,&nbsp;1&nbsp;)** |![turquoise](./media/function-colors/color-turquoise.png) |
| **Color.Violet** |**ColorValue( "#ee82ee"&nbsp;)**<br>**ColorValue («Fiolett»&nbsp;)** |**RGBA (&nbsp;238,&nbsp;130,&nbsp;238,&nbsp;1&nbsp;)** |![violet](./media/function-colors/color-violet.png) |
| **Color.Wheat** |**ColorValue( "#f5deb3"&nbsp;)**<br>**ColorValue («HVETE»&nbsp;)** |**RGBA(&nbsp;245,&nbsp;222,&nbsp;179,&nbsp;1&nbsp;)** |![wheat](./media/function-colors/color-wheat.png) |
| **Color.White** |**ColorValue («#ffffff»&nbsp;)**<br>**ColorValue («Hvit»&nbsp;)** |**RGBA(&nbsp;255,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![white](./media/function-colors/color-white.png) |
...
| **Color.Yellow** |**ColorValue ("#ffff00"&nbsp;)**<br>**ColorValue ("Gul"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;255,&nbsp;0,&nbsp;1&nbsp;)** |![yellow](./media/function-colors/color-yellow.png) |
