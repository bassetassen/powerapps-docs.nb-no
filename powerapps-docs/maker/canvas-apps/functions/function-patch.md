...
### <a name="modify-or-create-a-record-in-a-data-source"></a>Endre eller opprette en post i en datakilde
Hvis du vil bruke denne funksjonen med en datakilde, kan du angi datakilden og deretter angi en grunnleggende post:

* Hvis du vil endre en post, må den grunnleggende posten ha kommet fra en datakilde.  Den grunnleggende posten kan ha blitt levert gjennom **[Elementer](../controls/properties-core.md)**-egenskapen i et galleri, blitt plassert i en [kontekstvariabel](../working-with-variables.md#create-a-context-variable) eller gått gjennom en annen bane. Men du skal kunne spore den grunnleggende posten tilbake til datakilden.  Dette er viktig, da posten inneholder tilleggsinformasjon for å hjelpe deg med å finne posten på nytt for redigering.  
...
Når du oppdaterer en datakilde, kan det oppstå et eller flere problemer. Bruk **[Errors](function-errors.md)**-funksjonen til å identifisere og undersøke problemer, som beskrives i [Arbeide med datakilder](../working-with-data-sources.md).
...
### <a name="modify-or-create-a-set-of-records-in-a-data-source"></a>Endre eller opprette et sett med poster i en datakilde
**Patch** kan også brukes til å opprette eller endre flere poster med ett enkelt oppkall.

I stedet for å sende én grunnleggende post kan en tabell med grunnleggende poster angis i det andre argumentet.  Endringsposter er også inkludert i en tabell, tilsvarende én-til-én med de grunnleggende postene.  Antall poster i hver endringstabell må være den samme som antall poster i den grunnleggende tabellen.
...
### <a name="merge-records-outside-of-a-data-source"></a>Flette poster utenfor en datakilde
...
**Patch** returnerer de flettede postene og endrer ikke tilhørende argumenter eller poster i noen datakilder.
...
#### <a name="merge-records"></a>Flette poster
