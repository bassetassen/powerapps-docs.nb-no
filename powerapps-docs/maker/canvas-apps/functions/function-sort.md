...
1. Legg til en knapp, og angi **[OnSelect](../controls/properties-core.md)** -egenskapen til denne formelen:<br>**ClearCollect (IceCream, {Flavor: «Sjokolade», antall: 100, OnOrder: 150}, {Flavor:  "Vanilla", antall: 200, OnOrder: 20}, {Flavor: "Strawberry", antall: 300, OnOrder: 0}, {Flavor: «Grønnhvit sjokolade», antall: 60, OnOrder: 100}, {Flavor: "Pistachio", antall: 200, OnOrder: 10})**
...
1. Legg til en ny knapp, og angi **[OnSelect](../controls/properties-core.md)** -egenskapen til denne formelen:<br>
   **ClearCollect( SortByQuantity, SortByColumns( IceCream, "Quantity", Ascending, "Flavor", Descending ) )**
     ...
     Formelen over oppretter en tredje samling, kalt **SortByQuantity**, som inneholder de samme dataene som **Ice Cream**. Den nye samlingen inneholder imidlertid dataene sortert numerisk etter **antall** -kolonnen i stigende rekkefølge, og deretter etter **Flavor** -kolonnen i synkende rekkefølge.
2. Trykk på F5, velg den nye knappen, og trykk deretter på ESC.
