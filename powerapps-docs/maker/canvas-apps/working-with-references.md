...
1. I navigasjons feltet til venstre velger du **Data** > **enheter**.
...
1. Rull ned til **eier** -feltet vises.
 ...
 > ![Owner-felt på kontoen het @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Accounts som vises i en Galleri kontroll @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Accounts, team-og bruker enheter i data-ruten @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Accounts som vises i en Galleri-kontroll med Owner-felt som vises @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Experimental Bytt til å aktivere feil administrasjon på formel nivå @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Added kombinasjons boks kontroll ovenfor galleri med elementer-egenskap satt til brukere @ no__t-1
...
> [!div class="mx-imgBorder"]
> Galleri for ![Filtered basert på verdi sett i kombinasjons boks kontrollen @ no__t-1
...
1. Til slutt angir du **elementer** -egenskapen for **Galleri** -kontrollen til denne formelen:
    ...
    > [!div class="mx-imgBorder"]
    > ![Filtered galleri som viser alle poster eller en bestemt bruker eller hvert team @ no__t-1

Med disse endringene kan du vise alle poster eller filtrere dem basert på en bruker eller et team:

> [!div class="mx-imgBorder"]
> @no__t – 0Animation viser ulike filtrerte resultater basert på radio-kontrollen og kombinasjons boksene @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Filter etter eier type ved hjelp av IsType @ no__t-1
...
1. Velg **Kopier disse elementene**på ellipse-menyen.
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Copy for flere kontroller ved hjelp av tre visningen @ no__t-1

1. Velg **Lim inn**på samme-menyen.

    > [!div class="mx-imgBorder"]
    > @no__t – 0Paste for flere kontroller ved hjelp av tre visningen @ no__t-1

1. Flytt de kopierte kontrollene til høyre i galleriet.

    > [!div class="mx-imgBorder"]
    > ![Moved kopierte kontroller til høyre for galleriet @ no__t-1
...
1. Velg den kopierte **radio** -kontrollen, og endre deretter disse egenskapene:
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Removed alt valg fra Radio kontrollen @ no__t-1 
...
1. Velg den synlige **kombinasjons boks** -kontrollen, og angi deretter **DefaultSelectedItems** -egenskapen til denne formelen:
    ...
    > [!div class="mx-imgBorder"]
    > ![Default egenskaps sett for brukerens kombinasjons boks @ no__t-1
...
1. Velg den synlige **kombinasjons boks** kontrollen for Teams, og angi deretter **DefaultSelectedItems** -egenskapen til denne formelen:
    ...
    > [!div class="mx-imgBorder"]
    > ![Default-egenskap angitt for kombinasjons boksen Teams @ no__t-1

1. Sett inn en **knapp** -kontroll, Flytt den under **kombinasjons boks** -kontrollen, og angi deretter **tekst** -egenskapen for knappen til `"Patch Owner"`.
...
1. Angi **OnSelect** -egenskapen for knappen til denne formelen:
    ...
    > [!div class="mx-imgBorder"]
    > ![Formula som er angitt på knappe kontrollen @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Animation som viser en eier av eieren med enten en bruker eller et team @ no__t-1
...
1. Åpne **data kilde** -listen på **Egenskaper** -fanen nær høyre side av skjermen, og velg deretter **kontoer**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Form-kontroll som viser ekstra felt med tomme verdier @ no__t-1  

1. Angi skjemaets **element** -egenskap til `Gallery1.Selected`.

    > [!div class="mx-imgBorder"]
    > ![Form-kontroll som viser ekstra felt som er fylt ut fra det valgte elementet i galleriet @ no__t-1
...
1. Velg ellipsen i **felt** -ruten, og velg deretter **Legg til et egen definert kort**.
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Command for å legge til et egen definert kort @ no__t-1
...
1. Endre størrelsen på kortet etter behov for å vise all teksten.
    ...
    > [!div class="mx-imgBorder"]
    > ![Inserted egen definert kort, tomt @ no__t-1
...
1. Sett inn en **etikett** -kontroll i det egen definerte kortet, og angi deretter **tekst** -egenskapen for etiketten til formelen du brukte i galleriet:
    ...
    > [!div class="mx-imgBorder"]
    > ![Custom-kort som viser eier-feltet i en etikett-kontroll @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Animation som viser skjema kontrollen som svarer på endringer i galleriet @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Contact enhet som viser firmanavn-felt som kunde data type som ikke er nødvendig @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Accounts, Teams, brukere og kontakt enheter i data-ruten @ no__t-1

Behandling av feltene **kunde** og **eier** er så likt at du kan kopiere appen (**fil**@no__t – 3**Lagre som**, og deretter angi et annet navn) og gjøre disse enkle omplasseringene:
...
> [!div class="mx-imgBorder"]
> ![Customer som er avledet fra eier appen med enkle endringer brukt @ no__t-1

To viktige forskjeller mellom **kunden** og **eieren** krever en oppdatering av formlene i galleriet og skjemaet:

1. Én-til-mange-relasjoner mellom **kontoer** og **kontakter** prioriteres når du refererer til disse enhets typene etter navn. I stedet for **kontoer**, kan du bruke **\[ @ no__t-3Accounts]** ; Bruk **\[ @ no__t-7Contacts]** i stedet for **kontakter**. Ved å bruke den [globale detvetydige operatoren](functions/operators.md#disambiguation-operator), sikrer du at du refererer til enhets typen i **IsType** og **AsType**. Dette problemet finnes bare i post konteksten til galleri-og skjema kontrollene.
...
> [!div class="mx-imgBorder"]
> ![Update til tekst-egenskapen for kontrollen for under tittel etikett i galleriet @ no__t-1

Med disse endringene kan du vise og endre **Firmanavn** -feltet i **kontakter** -enheten.

> [!div class="mx-imgBorder"]
> ![Animation som viser hvordan du velger en kontakt, endrer de andre kontrollene og skjemaet @ no__t-1
...
> [!div class="mx-imgBorder"]
> ruten ![Data som viser kontoer, team, brukere, kontakter og faks enheter @ no__t-1
...
> [!div class="mx-imgBorder"]
> Tekst egenskap for ![Updated for under tittel-kontrollen for å angående oppslag @ no__t-1

Når du har gjort disse endringene, arbeider du med **angående** -oppslag på samme måte som du gjorde **eier** -og **kunde** oppslagene.

> [!div class="mx-imgBorder"]
> ![Animation som viser hvordan du velger et element i galleriet, endrer de andre kontrollene og skjemaet @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Relationships for telefaksen heten som viser om mange-til-én-relasjoner @ no__t-1

Hvis du viser relasjonene for **kontoer** -enheten, vises alle enheter som kan være en kilde for et **angående** oppslags felt.

> [!div class="mx-imgBorder"]
> @no__t – 0Relationships for kontoen heten som viser om én-til-mange-relasjoner @ no__t-1
...
1. Legg til en annen skjerm.
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Insert en tom skjerm @ no__t-1
...
1. På **Egenskaper** -fanen, nær høyre side av skjermen, kan du angi **elementene** i galleriet til- **kontoer**.
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Set elementer til kontoer i egenskaps ruten @ no__t-1

1. Angi oppsettet for galleriet til **Tittel**, og angi deretter Tittel-feltet til **konto navn**.

    > [!div class="mx-imgBorder"]
    > ![Set oppsett til tittel for Galleri-kontrollen i egenskaper-ruten @ no__t-1

1. Legg til et annet galleri, endre størrelsen på den, og Flytt den til høyre side av skjermen.

1. Angi **element** -egenskapen for det nye galleriet til `Gallery2.Selected.Faxes`.

    Dette trinnet returnerer den filtrerte listen over fakser for en gitt konto.

    > [!div class="mx-imgBorder"]
    > @no__t – 0Set elementer-egenskapen for galleriet som viser fakser @ no__t-1
...
1. Angi oppsettet for galleriet til **Tittel og under tittel**, og angi deretter Tittel-feltet for å vise **Emne** -feltet (som kan være **Emne**med små bokstaver).
    ...
    > [!div class="mx-imgBorder"]
    > @no__t – 0Set tittel til emne felt @ no__t-1

Når du velger et element i listen over kontoer, viser faks listen faks bare for denne kontoen.

> [!div class="mx-imgBorder"]
> @no__t – 0Animation som viser utvalget i konto galleriet, driver listen over fakser @ no__t-1
...
> [!div class="mx-imgBorder"]
> @no__t – 0List av enheter som viser aktivitets enheten @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Change for elementer-egenskap for det andre galleriet, endre fra fakser til aktiviteter @ no__t-1
...
> [!div class="mx-imgBorder"]
> ruten ![Data viser alle enhetene som kreves for IsType-funksjonen @ no__t-1
...
> [!div class="mx-imgBorder"]
> @no__t – 0Set tekst egenskap til formel for å vise informasjon for telefakser, telefon samtaler og andre aktiviteter @ no__t-1
...
> [!div class="mx-imgBorder"]
> tekst egenskap for ![Expanded med mer informasjon for en telefon samtale @ no__t-1
...
> [!div class="mx-imgBorder"]
> @no__t – 0Completed skjerm som viser informasjon for ulike typer aktiviteter @ no__t-1
...
> [!div class="mx-imgBorder"]
> @no__t – 0Enabling vedlegg og merknader ved oppretting av en enhet @ no__t-1
...
> [!div class="mx-imgBorder"]
> ![Account-enhet som viser relasjon til notater gjennom en én-til-mange-relasjon @ no__t-1
