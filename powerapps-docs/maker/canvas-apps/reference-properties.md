...
**[SelectMultiple](controls/control-list-box.md)** – om en bruker kan velge flere enn ett element i en liste.  Gjelder for **[Listeboks](controls/control-list-box.md)**-kontrollen.
