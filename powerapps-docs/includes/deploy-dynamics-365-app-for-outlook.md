---
title: Distribuere Dynamics 365-app for Outlook | MicrosoftDocs
ms.custom: ''
ms.date: '2017-04-20'
ms.reviewer: ''
...
manager: brycho
---
# <a name="deploy-dynamics-365-app-for-outlook"></a>Distribuere Dynamics 365-app for Outlook
Brukerne kan bruke [!INCLUDE[pn_ms_dyn_crm_app_for_outlook](../includes/pn-ms-dyn-crm-app-for-outlook.md)] til å utnytte kraften i [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] mens de bruker [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] på skrivebordet, nettet eller nettbrettet. Vis for eksempel informasjon om e-post- eller avtalemottakere, eller koble en [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)]-e-post eller -avtale til en [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]-oppføring, for eksempel en salgsmulighet, forretningsforbindelse eller sak. Du finner mer informasjon om det [!INCLUDE[pn_ms_dyn_crm_app_for_outlook](../includes/pn-ms-dyn-crm-app-for-outlook.md)] tilbyr, i [brukerhåndboken for Dynamics 365-appen for Outlook](http://go.microsoft.com/fwlink/p/?LinkID=613099).  
...
## <a name="comparing-dynamics-365-app-for-outlook-with-dynamics-365-for-outlook"></a>Sammenligne Dynamics 365-appen for Outlook med Dynamics 365 for Outlook  
...
5.  Under **Personvernrelaterte rettigheter** kontrollerer du at **Bruk Dynamics 365-app for Outlook** er satt til **Organisasjon**. Hvis ikke, klikker du **Bruk Dynamics 365-app for Outlook**.  
...
### <a name="supported-clients-per-feature"></a>Støttede klienter per funksjon  
 ...
 ![Klienter som støttes for hver Dynamics 365-app for Outlook-funksjon](media/clients-supported-for-each-dynamics-365-app-for-outlook-feature.png "Klienter som støttes for hver Dynamics 365-app for Outlook-funksjon")  
...
>  Nettbrett støttes ikke på dette tidspunktet (kommer CY2017).  
 ...
 [Les mer om støttede klienter i denne bloggen: Dynamics 365-app for Outlook Support Matrix](https://blogs.msdn.microsoft.com/crm/2016/12/13/dynamics-365-app-for-outlook-support-matrix/)  
...
> [!NOTE]
>  Brukere kan også deaktivere eller fjerne tillegget selv, om nødvendig. Hvis du vil ha mer informasjon, kan du se [brukerhåndboken for Dynamics 365-app for Outlook](http://go.microsoft.com/fwlink/p/?LinkID=613099).  
...
## <a name="to-deploy-to-dynamics-365-on-premises-users"></a>Distribuere til lokale Dynamics 365-brukere  
 Følg disse trinnene hvis du bruker Dynamics 365 lokalt.  
...
-   Hvis du kobler til Exchange loakalt, konfigurerer du OAuth-leverandøren og registrerer klientapper. Se [Konfigurere Windows Server 2012 R2 for Dynamics 365-apper som bruker OAuth](https://technet.microsoft.com/library/hh699726.aspx).  
...
## <a name="explore-the-users-guide-and-train-your-users"></a>Utforske brukerhåndboken og lære opp brukere  
 ...
 ![Siden Brukerveiledning for Dynamics 365-app for Outlook](media/dynamics-365-app-for-outlook-user-s-guide-page.png "Siden Brukerveiledning for Dynamics 365-app for Outlook")  
...
## <a name="see-also"></a>Se også  
 ...
 [Legge til brukere, lisenser og sikkerhetsroller](http://msdn.microsoft.com/en-us/23612155-f92d-4871-a109-186419d5c19d)   
