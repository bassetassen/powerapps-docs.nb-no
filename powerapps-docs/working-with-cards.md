---
title: Slik forstår du datakort | Microsoft Docs
...
---
# <a name="understand-data-cards"></a>Slik forstår du datakort
...
## <a name="customize-a-card"></a>Slik tilpasser du et kort
...
## <a name="unlock-a-card"></a>Slik låser du opp et kort
...
Banneret over **Avansert**-fanen indikerer at egenskapene for dette kortet er låst. Et låseikon vises også ved siden av **[DataField](controls/control-card.md)**-,  **[DisplayName](controls/control-card.md)**- og  **[Nødvendig](controls/control-card.md)**-egenskaper. Den høyre ruten opprettet disse formlene, og låsen hindrer tilfeldige endringer til disse egenskapene.
...
> [!TIP]
> Trykk på Alt-tasten for å vise navnet på hver kontroll.
...
**DefaultValue**- og **[Nødvendig](controls/control-card.md)**-egenskapene blir som standard hentet fra datakildens metadata, basert på **[DataField](controls/control-card.md)**-egenskapen. Du kan overstyre disse formlene med din egen logikk ved å integrere datakildens metadata ved hjelp av **[DataSourceInfo](functions/function-datasourceinfo.md)**-funksjonen.
...
Hold nede Alt-tasten for å vise navnene på kontrollene som utgjør dette kortet:
...
| **InputText** |**Inndatatekst**-kontrollen |Viser startverdien for feltet og lar brukeren endrer denne verdien. |
